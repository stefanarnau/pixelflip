...
dlmwrite([PATH_VEUSZ, 'lineplots_fz.csv'],  [mean(squeeze(erp_flip1_easy_post0(:, 11, :)), 1);...
...
dlmwrite([PATH_VEUSZ, 'lineplots_fcz.csv'], [mean(squeeze(erp_flip1_easy_post0(:, 20, :)), 1);...
...
dlmwrite([PATH_VEUSZ, 'lineplots_pz.csv'], [mean(squeeze(erp_flip1_easy_post0(:, 48, :)), 1);...
...
dlmwrite([PATH_VEUSZ, 'lineplots_poz.csv'], [mean(squeeze(erp_flip1_easy_post0(:, 57, :)), 1);...
