...
erp_1 = mean(squeeze(data_fcz(:, idx_easy_flip0)), 2);
erp_2 = mean(squeeze(data_fcz(:, idx_easy_flip1)), 2);
erp_3 = mean(squeeze(data_fcz(:, idx_hard_flip0)), 2);
erp_4 = mean(squeeze(data_fcz(:, idx_hard_flip1)), 2);

figure()
plot(EEG.times, [erp_1, erp_2, erp_3, erp_4])
